...
export default function CompressTo500KBPage() {
  ...
  const [targetSizeBytes, setTargetSizeBytes] = useState<number>(500 * 1024);
        ...
        <main className="flex-1 max-w-4xl w-full">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-100/80 text-blue-700 text-xs font-bold mb-4 border border-blue-200">
              ...
              <span>Preset ขนาดเป้าหมาย: 500KB</span>
            </div>

            <h1 className="text-3xl sm:text-5xl font-black text-slate-900 tracking-tight leading-tight">
              บีบอัด PDF ให้เหลือไม่เกิน 500KB <br />
              <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                รวดเร็ว ปลอดภัย ปรับขนาดไฟล์ได้จริง
              </span>
            </h1>

            <p className="text-base text-slate-600 mt-4 leading-relaxed font-medium">
              ย่อขนาดไฟล์ PDF ให้เล็กกว่า 500 KB สำหรับระบบยื่นเอกสารราชการ ยื่นวีซ่า หรืออัปโหลดเอกสารนักเรียนนักศึกษา
            </p>
          </div>
              ...
              <>
                ...
                {file && (
                  ...
                  >
                    ...
                    <span>เริ่มบีบอัด PDF ให้เหลือไม่เกิน 500KB</span>
                  </button>
                )}
              </>
            )}
          ...
          <SEOContent title="บีบอัด PDF เหลือ 500KB" targetPresetText="ไม่เกิน 500KB" />
          <FAQSection />
        </main>
