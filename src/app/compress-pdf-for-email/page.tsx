...
export default function CompressForEmailPage() {
  ...
  const [targetSizeBytes, setTargetSizeBytes] = useState<number>(2 * 1024 * 1024);
        ...
        <main className="flex-1 max-w-4xl w-full">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-100/80 text-blue-700 text-xs font-bold mb-4 border border-blue-200">
              ...
              <span>Preset ขนาดเป้าหมายสำหรับส่งอีเมล</span>
            </div>

            <h1 className="text-3xl sm:text-5xl font-black text-slate-900 tracking-tight leading-tight">
              บีบอัดไฟล์ PDF สำหรับแนบส่งอีเมล <br />
              <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                ย่อขนาดไฟล์แนบไม่ให้ส่งแล้วตีกลับ
              </span>
            </h1>

            <p className="text-base text-slate-600 mt-4 leading-relaxed font-medium">
              หมดปัญหาไฟล์แนบใหญ่เกินข้อกำหนดเซิร์ฟเวอร์อีเมล ปรับย่อขนาดเอกสาร PDF ให้เหมาะสมกับ Gmail, Outlook และ Mail องค์กร
            </p>
          </div>
              ...
              <>
                ...
                {file && (
                  ...
                  >
                    ...
                    <span>เริ่มบีบอัด PDF สำหรับส่งอีเมล</span>
                  </button>
                )}
              </>
            )}
          ...
          <SEOContent title="บีบอัด PDF สำหรับส่งอีเมล" targetPresetText="สำหรับแนบส่งอีเมล" />
          <FAQSection />
        </main>
